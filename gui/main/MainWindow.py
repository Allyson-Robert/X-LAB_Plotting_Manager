...
sys.path.append("../..")
from plugins import devices
from plugins.devices import *
import fileset as fs
from gui.data_creator import DataCreatorWindow
...
class UiMainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        # Define devices indices corresponding to stackedWidget definition (see QtDesigner)
        self.devices = {
            '': 0,
            'Sunbrick': 1,
            'Stability': 2,
        ...
        # Define possible plot types to show to the user for each devices
        self.plot_types = {
    ...
    def load_data(self):
        ...
        # Some changes depend on the type of devices
    ...
    def plot_manager(self):
        ...
        # Instantiate proper devices class and set the data
        current_device = self.fileset.get_device()
        experiment_cls = getattr(devices, current_device)
        ...
        # Create a new thread for the devices class to run in
